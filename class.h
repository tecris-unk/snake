...
private:
    ...
    std::vector <char> ruler;
    std::vector <std::pair <int, int> > coords;
public:
    void createMap()
    {
        map = std::vector <std::vector <int> > (size, std::vector <int> (size));
    ...
    void play()
    {
        ruler = std::vector <char> (snakeSize);
        coords = std::vector <std::pair <int, int> > (snakeSize);
